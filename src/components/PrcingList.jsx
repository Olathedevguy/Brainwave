      ...
      {pricing.map((item) => (
        <div
          ...
          <Button
            ...
            href={item.price ? "/pricing" : "mailto:jolamideprince@gmail.com"}
            white={!!item.price}>
            {/* double exclamation mark turns the truthy/falsy value to pure true/false */}
